...
This repository contains the final delivery material for the Software Design and Architecture project on Spack. The analyzed codebase is maintained separately in the team's GitHub organization as a fork of the official Spack repository; this repository is used only to collect the submitted reports and individual journals.
